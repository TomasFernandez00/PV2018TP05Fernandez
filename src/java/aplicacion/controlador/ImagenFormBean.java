...
public class ImagenFormBean implements Serializable {
	...
	private ListadoImagen listadoImagenes;
	...
	public ImagenFormBean() {
		listadoImagenes = new ListadoImagen();
	}
	 ...
	 */
	public ListadoImagen getListadoImagenes() {
	 ...
	 */
	public void setListadoImagenes(ListadoImagen listadoImagenes) {
